<div>
  ...
  <div class="top-app-bar-container">
    ...
    <Checkbox bind:checked={prominent}>Prominent</Checkbox>
    <Checkbox bind:checked={dense}>Dense</Checkbox>
    <Checkbox bind:checked={secondaryColor}>Secondary Color</Checkbox>
  </div>